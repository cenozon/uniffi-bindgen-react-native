...
#define UBRN_NITRO_PRIM_THUNK(T, suffix) \
    ...
    inline void write_##suffix(Writer<A, R>& w, T v) { w.write_##suffix(v); } \
...
inline std::string read_string(RustBufferReader& r) {
...
inline std::chrono::system_clock::time_point read_timestamp(RustBufferReader& r) {
...
inline double read_duration(RustBufferReader& r) {
